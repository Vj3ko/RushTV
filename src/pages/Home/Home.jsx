...
const StyledHero = styled.div`
  ...
  .overlay {
    ...
    right: 0;
    bottom: -1px;
    background: radial-gradient(rgba(11, 12, 15, 1), rgba(11, 12, 15, 0)),
      linear-gradient(
        180deg,
        rgba(11, 12, 15, 0) 80%,
        rgba(11, 12, 15, 0.9) 95%,
        rgba(11, 12, 15, 1) 100%
      );
  }
  ...
  .scrollToContent {
    ...
    &.second {
      pointer-events: none;
      animation: bounce 1s 0.3s infinite alternate;
    }
  }
  ...
  return (
    <AnimatedComponent>
      <StyledHero>
        <img
          src={heroImg}
          alt='background filled with random movie and tv posters'
        />
        <h1>
        ...
        <p>
          ...
          you're in the mood for a thrilling action-packed film, a heartwarming
          romance, or a gripping TV series, Rush TV has got you covered.
        </p>
        <button
      ...
      <Container>
        <Description ref={desc}>
          ...
          <p>
            ...
            our extensive library ensures that you'll find exactly what you're
            looking for.
          </p>
