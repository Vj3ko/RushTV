        ...
        <div className='wrapper'>
          ...
          <Container>
            <div className="media">
              ...
              <h1>{data?.title}
                {data?.release_date && <span className='year'>({formatYear(data.release_date)})</span>}
              </h1>
        ...
        <Container >
            ...
            <StatsSection>
              ...
              <div className='genre--wrapper'>
                {data.genres.map(genre =>
                  <span key={genre.name} className='genres'>{genre.name}</span>
                )}
              </div>
            </StatsSection>
          )}
            ...
            <StatsSection>
              ...
              <div className="companies--wrapper">
                {data.production_companies.map(company =>
                  <span key={company.name} className='genres'>{company.name}</span>
                )}
              </div>
            </StatsSection>
          )}
          ...
          {(data?.recommendations?.results && data?.recommendations?.results.length > 0) && (
            <StatsSection>
              ...
              <Slider gallery={data.recommendations.results} mediaType="movie" />
            </StatsSection>
          )}
