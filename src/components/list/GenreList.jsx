    ...
    <AnimatedComponent>
      <ListSection>
        <Container>
          ...
          <FilterBtns>
            <StyledButton onClick={() => setFilter("popularity.desc")}>Most Popular</StyledButton>
            <StyledButton onClick={() => setFilter("vote_count.desc")}>Most Voted</StyledButton>
            <StyledButton onClick={() => setFilter("popularity.asc")}>Least Popular</StyledButton>
            <StyledButton onClick={() => setFilter("revenue.desc")}>Biggest Revenue</StyledButton>
            <StyledButton onClick={() => setFilter("primary_release_date.desc")}>Latest</StyledButton>
            <StyledButton onClick={() => setFilter("primary_release_date.asc")}>Oldest</StyledButton>
          </FilterBtns>
