          ...
          <ApiContext.Provider value={{ KEY, URL, IMG_URL }}>
            <AnimatePresence mode='wait'>
              <Routes location={location} key={location.pathname}>
                ...
                <Route
                  path='/popular/movies'
                  element={<PopularList mediaType='movie' title='movies' />}
                />
                <Route
                  path='/popular/tv'
                  element={<PopularList mediaType='tv' title='Tv Shows' />}
                />
                <Route
                  path='/popular/people'
                  element={<PopularList mediaType='person' title='people' />}
                />
                ...
                <Route
                  path='/top-rated/tv'
                  element={
                    <TopRatedList mediaType='tv' link='tv' title='Tv Shows' />
                  }
                />
                ...
                <Route
                  path='/discover/tv/genre/action&adventure'
                  element={
                    <GenreList
                      mediaType='tv'
                      link='tv'
                ...
                />
                <Route
                  path='/discover/tv/genre/documentary'
                  element={
                    <GenreList
                      mediaType='tv'
                      link='tv'
                ...
                />
                <Route
                  path='/discover/tv/genre/sci-fi&fantasy'
                  element={
                    <GenreList
                      mediaType='tv'
                      link='tv'
                ...
                />
                <Route
                  path='/discover/movies/genre/documentary'
                  element={
                    <GenreList
                      mediaType='movie'
                      link='movie'
                ...
                />
                <Route
                  path='/discover/movies/genre/sci-fi&fantasy'
                  element={
                    <GenreList
                      mediaType='movie'
                      link='movie'
